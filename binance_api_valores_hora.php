...
while ($contador <= 9) 
{
	    ...
	    $url = "https://api.binance.com/api/v3/klines?symbol=$name&interval=1h&limit=1";
		...
		if ($Close >= $mms25){
	    $sql = "INSERT INTO HORA (name,Open_time,Open,High,Low,Close,Volume,Close_time,Quote_asset_volume,Number_of_trades,Taker_buy_base_asset_volume,Taker_buy_quote_asset_volume,Ignore_value,controle_mms25)
