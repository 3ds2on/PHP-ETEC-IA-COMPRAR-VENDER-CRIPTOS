...
class Mediamovel99
{
    ...
    function calcula_media_movel99()
    { 
	...
	$result = mysqli_query($connection, "SELECT id, Close, name  FROM MINUTO WHERE name = '$this->instrument_id' ORDER BY id desc LIMIT 81;");  
	while ($data = mysqli_fetch_array($result)){$id81 =  $data[0];$valor81 = $data[1]; $moeda81 = $data[2];}
	$result = mysqli_query($connection, "SELECT id, Close, name  FROM MINUTO WHERE name = '$this->instrument_id' ORDER BY id desc LIMIT 82;");  
	while ($data = mysqli_fetch_array($result)){$id82 =  $data[0];$valor82 = $data[1]; $moeda82 = $data[2];}
	$result = mysqli_query($connection, "SELECT id, Close, name  FROM MINUTO WHERE name = '$this->instrument_id' ORDER BY id desc LIMIT 83;");  
	while ($data = mysqli_fetch_array($result)){$id83 =  $data[0];$valor83 = $data[1]; $moeda83 = $data[2];}
	$result = mysqli_query($connection, "SELECT id, Close, name  FROM MINUTO WHERE name = '$this->instrument_id' ORDER BY id desc LIMIT 84;");  
	while ($data = mysqli_fetch_array($result)){$id84 =  $data[0];$valor84 = $data[1]; $moeda84 = $data[2];}
	$result = mysqli_query($connection, "SELECT id, Close, name  FROM MINUTO WHERE name = '$this->instrument_id' ORDER BY id desc LIMIT 85;");  
	while ($data = mysqli_fetch_array($result)){$id85 =  $data[0];$valor85 = $data[1]; $moeda85 = $data[2];}
	$result = mysqli_query($connection, "SELECT id, Close, name  FROM MINUTO WHERE name = '$this->instrument_id' ORDER BY id desc LIMIT 86;");  
	while ($data = mysqli_fetch_array($result)){$id86 =  $data[0];$valor86 = $data[1]; $moeda86 = $data[2];}
	$result = mysqli_query($connection, "SELECT id, Close, name  FROM MINUTO WHERE name = '$this->instrument_id' ORDER BY id desc LIMIT 87;");  
	while ($data = mysqli_fetch_array($result)){$id87 =  $data[0];$valor87 = $data[1]; $moeda87 = $data[2];}
	$result = mysqli_query($connection, "SELECT id, Close, name  FROM MINUTO WHERE name = '$this->instrument_id' ORDER BY id desc LIMIT 88;");  
	while ($data = mysqli_fetch_array($result)){$id88 =  $data[0];$valor88 = $data[1]; $moeda88 = $data[2];}
	$result = mysqli_query($connection, "SELECT id, Close, name  FROM MINUTO WHERE name = '$this->instrument_id' ORDER BY id desc LIMIT 89;");  
	while ($data = mysqli_fetch_array($result)){$id89 =  $data[0];$valor89 = $data[1]; $moeda89 = $data[2];}
	$result = mysqli_query($connection, "SELECT id, Close, name  FROM MINUTO WHERE name = '$this->instrument_id' ORDER BY id desc LIMIT 90;");  
	while ($data = mysqli_fetch_array($result)){$id90 =  $data[0];$valor90 = $data[1]; $moeda90 = $data[2];}
	$result = mysqli_query($connection, "SELECT id, Close, name  FROM MINUTO WHERE name = '$this->instrument_id' ORDER BY id desc LIMIT 91;");  
	while ($data = mysqli_fetch_array($result)){$id91 =  $data[0];$valor91 = $data[1]; $moeda91 = $data[2];}
	$result = mysqli_query($connection, "SELECT id, Close, name  FROM MINUTO WHERE name = '$this->instrument_id' ORDER BY id desc LIMIT 92;");  
	while ($data = mysqli_fetch_array($result)){$id92 =  $data[0];$valor92 = $data[1]; $moeda92 = $data[2];}
	$result = mysqli_query($connection, "SELECT id, Close, name  FROM MINUTO WHERE name = '$this->instrument_id' ORDER BY id desc LIMIT 93;");  
	while ($data = mysqli_fetch_array($result)){$id93 =  $data[0];$valor93 = $data[1]; $moeda93 = $data[2];}
	$result = mysqli_query($connection, "SELECT id, Close, name  FROM MINUTO WHERE name = '$this->instrument_id' ORDER BY id desc LIMIT 94;");  
	while ($data = mysqli_fetch_array($result)){$id94 =  $data[0];$valor94 = $data[1]; $moeda94 = $data[2];}
	$result = mysqli_query($connection, "SELECT id, Close, name  FROM MINUTO WHERE name = '$this->instrument_id' ORDER BY id desc LIMIT 95;");  
	while ($data = mysqli_fetch_array($result)){$id95 =  $data[0];$valor95 = $data[1]; $moeda95 = $data[2];}
	$result = mysqli_query($connection, "SELECT id, Close, name  FROM MINUTO WHERE name = '$this->instrument_id' ORDER BY id desc LIMIT 96;");  
	while ($data = mysqli_fetch_array($result)){$id96 =  $data[0];$valor96 = $data[1]; $moeda96 = $data[2];}
	$result = mysqli_query($connection, "SELECT id, Close, name  FROM MINUTO WHERE name = '$this->instrument_id' ORDER BY id desc LIMIT 97;");  
	while ($data = mysqli_fetch_array($result)){$id97 =  $data[0];$valor97 = $data[1]; $moeda97 = $data[2];}
	$result = mysqli_query($connection, "SELECT id, Close, name  FROM MINUTO WHERE name = '$this->instrument_id' ORDER BY id desc LIMIT 98;");  
	while ($data = mysqli_fetch_array($result)){$id98 =  $data[0];$valor98 = $data[1]; $moeda98 = $data[2];}
	$result = mysqli_query($connection, "SELECT id, Close, name  FROM MINUTO WHERE name = '$this->instrument_id' ORDER BY id desc LIMIT 99;");  
	while ($data = mysqli_fetch_array($result)){$id99 =  $data[0];$valor99 = $data[1]; $moeda99 = $data[2];}
	$result = mysqli_query($connection, "SELECT id, Close, name  FROM MINUTO WHERE name = '$this->instrument_id' ORDER BY id desc LIMIT 100;"); 
	while ($data = mysqli_fetch_array($result)){$id100 = $data[0];$valor100 = $data[1]; $moeda100 = $data[2];}
	$result = mysqli_query($connection, "SELECT id, Close, name  FROM MINUTO WHERE name = '$this->instrument_id' ORDER BY id desc LIMIT 101;"); 

	$resultado = ($valor1 + $valor2 + $valor3 + $valor4 + $valor5 + $valor6 + $valor7 + $valor8 + $valor9 + $valor10 + $valor11 + $valor12 + $valor13 + $valor14 + $valor15 + $valor16 + $valor17 + $valor18 + $valor19 + $valor20 + $valor21 + $valor22 + $valor23 + $valor24 + $valor25 + $valor26 + $valor27 + $valor28 + $valor29 + $valor30 + $valor31 + $valor32 + $valor33 + $valor34 + $valor35 + $valor36 + $valor37 + $valor38 + $valor39 + $valor40 + $valor41 + $valor42 + $valor43 + $valor44 + $valor45 + $valor46 + $valor47 + $valor48 + $valor49 + $valor50 + $valor51 + $valor52 + $valor53 + $valor54 + $valor55 + $valor56 + $valor57 + $valor58 + $valor59 + $valor60 + $valor61 + $valor62 + $valor63 + $valor64 + $valor65 + $valor66 + $valor67 + $valor68 + $valor69 + $valor70 + $valor71 + $valor72 + $valor73 + $valor74 + $valor75 + $valor76 + $valor77 + $valor78 + $valor79 + $valor80 + $valor81 + $valor82 + $valor83 + $valor84 + $valor85 + $valor86 + $valor87 + $valor88 + $valor89 + $valor90 + $valor91 + $valor92 + $valor93 + $valor94 + $valor95 + $valor96 + $valor97 + $valor98 + $valor99)/99;

	return $mms99 = $resultado;
	}                                                                                                                    
}                                                                                                                     
?>